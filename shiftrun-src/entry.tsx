...
function App(){
 ...
 const toggle=()=>{const next=!showProfile;setShowProfile(next);const url=new URL(location.href);url.hash=next?'khanfarris':'';history.replaceState(null,'',url);};
...
createRoot(document.getElementById('root')!).render(<Presentation><App/></Presentation>);
